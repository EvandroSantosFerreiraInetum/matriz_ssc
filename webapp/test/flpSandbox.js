		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SSC Alocation",
									"targetURL": "#inetumssmalocationssc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"inetumssmalocationssc-display": {
								"semanticObject": "inetumssmalocationssc",
								"action": "display",
								"description": "SSC Alocation",
								"title": "SSC Alocation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=inetum.ssm.alocationssc",
									"url": sap.ui.require.toUrl("inetum/ssm/alocationssc")
								}
							}
						}
					}
